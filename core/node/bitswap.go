...
import (
	...
	"github.com/nnlgsakib/wwfs-sdk/bitswap/network/httpnet"
...
const (
	...
	DefaultMaxProviders                = 10 // matching BitswapClientDefaultMaxProviders from https://github.com/nnlgsakib/wwfs-sdk/blob/v0.29.1/bitswap/internal/defaults/defaults.go#L15
