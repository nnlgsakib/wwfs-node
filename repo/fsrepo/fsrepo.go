...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/nnlgsakib/wwfs-node/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://github.com/nnlgsakib/wwfs-node/issues/8088 for more details).
